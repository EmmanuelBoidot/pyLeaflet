!function(d3) {
  var pyLeaflet = {
    _pyLeafletIsLoaded: true,
    figures: [],
    plugin_map: {}
  };
  pyLeaflet.version = "0.2git";
  pyLeaflet.register_plugin = function(name, obj) {
    pyLeaflet.plugin_map[name] = obj;
  };
  pyLeaflet.draw_figure = function(figid, spec, withAxes) {
    var element = document.getElementById(figid);
    if (element === null) {
      throw figid + " is not a valid id";
    }
    var fig = new pyLeaflet.Figure(figid, spec);
  ...
  pyLeaflet.cloneObj = pyLeaflet_cloneObj;
  function pyLeaflet_cloneObj(oldObj) {
    var newObj = {};
  ...
  pyLeaflet.merge_objects = function(_) {
    var output = {};
    var obj;
  ...
  pyLeaflet.generate_id = function(N, chars) {
    console.warn("pyLeaflet.generate_id is deprecated. " + "Use pyLeaflet.generateId instead.");
    return pyLeaflet_generateId(N, chars);
  };
  pyLeaflet.generateId = pyLeaflet_generateId;
  function pyLeaflet_generateId(N, chars) {
  ...
  pyLeaflet.get_element = function(id, fig) {
    var figs_to_search, ax, el;
    if (typeof fig === "undefined") {
      figs_to_search = pyLeaflet.figures;
  ...
  pyLeaflet.insert_css = function(selector, attributes) {
  ...
  pyLeaflet.process_props = function(obj, properties, defaults, required) {
    console.warn("pyLeaflet.process_props is deprecated. " + "Plot elements should derive from pyLeaflet.PlotElement");
    Element.prototype = Object.create(pyLeaflet_PlotElement.prototype);
    Element.prototype.constructor = Element;
    Element.prototype.requiredProps = required;
    Element.prototype.defaultProps = defaults;
    function Element(props) {
      pyLeaflet_PlotElement.call(this, null, props);
    }
    var el = new Element(properties);
    return el.props;
  };
  pyLeaflet.interpolateDates = pyLeaflet_interpolateDates;
  function pyLeaflet_interpolateDates(a, b) {
  ...
  pyLeaflet.path = function() {
    return pyLeaflet_path();
  };
  function pyLeaflet_path(_) {
    var x = function(d, i) {
      return d[0];
    };
    var y = function(d, i) {
  ...
  pyLeaflet.multiscale = pyLeaflet_multiscale;
  function pyLeaflet_multiscale(_) {
  ...
  pyLeaflet.Grid = pyLeaflet_Grid;
  pyLeaflet_Grid.prototype = Object.create(pyLeaflet_PlotElement.prototype);
  pyLeaflet_Grid.prototype.constructor = pyLeaflet_Grid;
  pyLeaflet_Grid.prototype.requiredProps = [ "xy" ];
  pyLeaflet_Grid.prototype.defaultProps = {
    color: "gray",
    dasharray: "2,2",
    alpha: "0.5",
    nticks: 10,
  ...
  function pyLeaflet_Grid(ax, prop) {
    pyLeaflet_PlotElement.call(this, ax, prop);
  ...
  pyLeaflet_Grid.prototype.draw = function() {
    ...
    pyLeaflet.insert_css("div#" + this.ax.fig.figid + " ." + this.cssclass + " .tick", {
      stroke: this.props.color,
      "stroke-dasharray": this.props.dasharray,
      "stroke-opacity": this.props.alpha
    });
    pyLeaflet.insert_css("div#" + this.ax.fig.figid + " ." + this.cssclass + " path", {
      "stroke-width": 0
    });
  };
  pyLeaflet_Grid.prototype.zoomed = function() {
    this.elem.call(this.grid);
  };
  pyLeaflet.Axis = pyLeaflet_Axis;
  pyLeaflet_Axis.prototype = Object.create(pyLeaflet_PlotElement.prototype);
  pyLeaflet_Axis.prototype.constructor = pyLeaflet_Axis;
  pyLeaflet_Axis.prototype.requiredProps = [ "position" ];
  pyLeaflet_Axis.prototype.defaultProps = {
    nticks: 10,
    tickvalues: null,
    tickformat: null,
    fontsize: "11px",
  ...
  function pyLeaflet_Axis(ax, props) {
  ...
  pyLeaflet_Axis.prototype.getGrid = function() {
    var gridprop = {
    ...
    return new pyLeaflet_Grid(this.ax, gridprop);
  };
  pyLeaflet_Axis.prototype.draw = function() {
    ...
    pyLeaflet.insert_css("div#" + this.ax.fig.figid + " ." + this.cssclass + " line, " + " ." + this.cssclass + " path", {
      "shape-rendering": "crispEdges",
      stroke: this.props.axiscolor,
      fill: "none"
    });
    pyLeaflet.insert_css("div#" + this.ax.fig.figid + " ." + this.cssclass + " text", {
  ...
  pyLeaflet_Axis.prototype.zoomed = function() {
    this.elem.call(this.axis);
  };
  pyLeaflet.Coordinates = pyLeaflet_Coordinates;
  function pyLeaflet_Coordinates(trans, ax) {
  ...
  pyLeaflet_Coordinates.prototype.xy = function(d, ix, iy) {
    ix = typeof ix === "undefined" ? 0 : ix;
    iy = typeof iy === "undefined" ? 1 : iy;
    return [ this.x(d[ix]), this.y(d[iy]) ]
    // return map.latLngToLayerPoint([ this.x(d[ix]), this.y(d[iy]) ]);
  };
  pyLeaflet_Coordinates.prototype.x_data = function(x) {
    return this.ax.x(x);
  };
  pyLeaflet_Coordinates.prototype.y_data = function(y) {
    return this.ax.y(y);
  };
  pyLeaflet_Coordinates.prototype.x_display = function(x) {
    return x;
  };
  pyLeaflet_Coordinates.prototype.y_display = function(y) {
    return y;
  };
  pyLeaflet_Coordinates.prototype.x_axes = function(x) {
    return x * this.ax.width;
  };
  pyLeaflet_Coordinates.prototype.y_axes = function(y) {
    return this.ax.height * (1 - y);
  };
  pyLeaflet_Coordinates.prototype.x_figure = function(x) {
    return x * this.fig.width - this.ax.position[0];
  };
  pyLeaflet_Coordinates.prototype.y_figure = function(y) {
    return (1 - y) * this.fig.height - this.ax.position[1];
  };
  pyLeaflet.Path = pyLeaflet_Path;
  pyLeaflet_Path.prototype = Object.create(pyLeaflet_PlotElement.prototype);
  pyLeaflet_Path.prototype.constructor = pyLeaflet_Path;
  pyLeaflet_Path.prototype.requiredProps = [ "data" ];
  pyLeaflet_Path.prototype.defaultProps = {
    xindex: 0,
    yindex: 1,
    coordinates: "data",
    facecolor: "green",
  ...
  function pyLeaflet_Path(ax, props) {
    pyLeaflet_PlotElement.call(this, ax, props);
    this.data = ax.fig.get_data(this.props.data);
    this.pathcodes = this.props.pathcodes;
    this.pathcoords = new pyLeaflet_Coordinates(this.props.coordinates, this.ax);
    this.offsetcoords = new pyLeaflet_Coordinates(this.props.offsetcoordinates, this.ax);
    this.datafunc = pyLeaflet_path();
  }
  pyLeaflet_Path.prototype.nanFilter = function(d, i) {
    return !isNaN(d[this.props.xindex]) && !isNaN(d[this.props.yindex]);
  };
  pyLeaflet_Path.prototype.draw = function() {
    ...
    // this.datafunc.defined(this.nanFilter.bind(this)).x(function(d) {
    //   pt = map.latLngToLayerPoint([ this.pathcoords.x(d[this.props.xindex]),this.pathcoords.y(d[this.props.yindex]) ]);
    //   return pt.x;
    // }).y(function(d) {
    //   pt = map.latLngToLayerPoint([ this.pathcoords.x(d[this.props.xindex]),this.pathcoords.y(d[this.props.yindex]) ]);
    //   return pt.y;
  ...
  pyLeaflet_Path.prototype.elements = function(d) {
    return this.path;
  };
  pyLeaflet_Path.prototype.zoomed = function() {
  ...
  pyLeaflet.PathCollection = pyLeaflet_PathCollection;
  pyLeaflet_PathCollection.prototype = Object.create(pyLeaflet_PlotElement.prototype);
  pyLeaflet_PathCollection.prototype.constructor = pyLeaflet_PathCollection;
  pyLeaflet_PathCollection.prototype.requiredProps = [ "paths", "offsets" ];
  pyLeaflet_PathCollection.prototype.defaultProps = {
    xindex: 0,
    yindex: 1,
    pathtransforms: [],
  ...
  function pyLeaflet_PathCollection(ax, props) {
    pyLeaflet_PlotElement.call(this, ax, props);
    ...
    this.pathcoords = new pyLeaflet_Coordinates(this.props.pathcoordinates, this.ax);
    this.offsetcoords = new pyLeaflet_Coordinates(this.props.offsetcoordinates, this.ax);
  }
  pyLeaflet_PathCollection.prototype.transformFunc = function(d, i) {
  ...
  pyLeaflet_PathCollection.prototype.draw = function() {
  ...
  pyLeaflet_PathCollection.prototype.elements = function(d) {
    return this.group.selectAll("path");
  };
  pyLeaflet_PathCollection.prototype.zoomed = function() {
  ...
  pyLeaflet.Line = pyLeaflet_Line;
  pyLeaflet_Line.prototype = Object.create(pyLeaflet_Path.prototype);
  pyLeaflet_Line.prototype.constructor = pyLeaflet_Line;
  pyLeaflet_Line.prototype.requiredProps = [ "data" ];
  pyLeaflet_Line.prototype.defaultProps = {
    xindex: 0,
    yindex: 1,
    coordinates: "data",
    color: "salmon",
  ...
  function pyLeaflet_Line(ax, props) {
    pyLeaflet_PlotElement.call(this, ax, props);
    ...
    this.defaultProps = pyLeaflet_Path.prototype.defaultProps;
    pyLeaflet_Path.call(this, ax, pathProps);
    this.datafunc = d3.svg.line().interpolate("linear");
  }
  pyLeaflet.Markers = pyLeaflet_Markers;
  pyLeaflet_Markers.prototype = Object.create(pyLeaflet_PathCollection.prototype);
  pyLeaflet_Markers.prototype.constructor = pyLeaflet_Markers;
  pyLeaflet_Markers.prototype.requiredProps = [ "data" ];
  pyLeaflet_Markers.prototype.defaultProps = {
    xindex: 0,
    yindex: 1,
    coordinates: "data",
    facecolor: "salmon",
  ...
  pyLeaflet_Markers.prototype.pathFunc = function(d, i) {
    return this.marker;
  };
  pyLeaflet.Image = pyLeaflet_Image;
  pyLeaflet_Image.prototype = Object.create(pyLeaflet_PlotElement.prototype);
  pyLeaflet_Image.prototype.constructor = pyLeaflet_Image;
  pyLeaflet_Image.prototype.requiredProps = [ "data", "extent" ];
  pyLeaflet_Image.prototype.defaultProps = {
    alpha: 1,
    coordinates: "data",
    zorder: 1
  };
  function pyLeaflet_Image(ax, props) {
    pyLeaflet_PlotElement.call(this, ax, props);
    this.coords = new pyLeaflet_Coordinates(this.props.coordinates, this.ax);
  }
  pyLeaflet_Image.prototype.draw = function() {
  ...
  pyLeaflet_Image.prototype.elements = function(d) {
    return d3.select(this.image);
  };
  pyLeaflet_Image.prototype.zoomed = function() {
  ...
  pyLeaflet.Text = pyLeaflet_Text;
  pyLeaflet_Text.prototype = Object.create(pyLeaflet_PlotElement.prototype);
  pyLeaflet_Text.prototype.constructor = pyLeaflet_Text;
  pyLeaflet_Text.prototype.requiredProps = [ "text", "position" ];
  pyLeaflet_Text.prototype.defaultProps = {
    coordinates: "data",
    h_anchor: "start",
    v_baseline: "auto",
    rotation: 0,
  ...
  function pyLeaflet_Text(ax, props) {
    pyLeaflet_PlotElement.call(this, ax, props);
    this.text = this.props.text;
    this.position = this.props.position;
    this.coords = new pyLeaflet_Coordinates(this.props.coordinates, this.ax);
  }
  pyLeaflet_Text.prototype.draw = function() {
  ...
  pyLeaflet_Text.prototype.elements = function(d) {
    return d3.select(this.obj);
  };
  pyLeaflet_Text.prototype.applyTransform = function() {
  ...
  pyLeaflet_Text.prototype.zoomed = function() {
    if (this.coords.zoomable) this.applyTransform();
  };
  pyLeaflet.Axes = pyLeaflet_Axes;
  pyLeaflet_Axes.prototype = Object.create(pyLeaflet_PlotElement.prototype);
  pyLeaflet_Axes.prototype.constructor = pyLeaflet_Axes;
  pyLeaflet_Axes.prototype.requiredProps = [ "xlim", "ylim" ];
  pyLeaflet_Axes.prototype.defaultProps = {
    bbox: [ .1, .1, .8, .8 ],
    axesbg: "#FFFFFF",
    axesbgalpha: 1,
    gridOn: false,
  ...
  function pyLeaflet_Axes(fig, props) {
    pyLeaflet_PlotElement.call(this, fig, props);
    ...
    if (this.props.xscale === "date") {
      this.x = pyLeaflet.multiscale(d3.scale.linear().domain(this.props.xlim).range(this.props.xdomain.map(Number)), this.xdom);
    }
    if (this.props.yscale === "date") {
      this.x = pyLeaflet.multiscale(d3.scale.linear().domain(this.props.ylim).range(this.props.ydomain.map(Number)), this.ydom);
    }
    var axes = this.props.axes;
    for (var i = 0; i < axes.length; i++) {
      var axis = new pyLeaflet.Axis(this, axes[i]);
    ...
    for (var i = 0; i < paths.length; i++) {
      this.elements.push(new pyLeaflet.Path(this, paths[i]));
    }
    var lines = this.props.lines;
    for (var i = 0; i < lines.length; i++) {
      this.elements.push(new pyLeaflet.Line(this, lines[i]));
    }
    var markers = this.props.markers;
    for (var i = 0; i < markers.length; i++) {
      this.elements.push(new pyLeaflet.Markers(this, markers[i]));
    }
    var texts = this.props.texts;
    for (var i = 0; i < texts.length; i++) {
      this.elements.push(new pyLeaflet.Text(this, texts[i]));
    }
    var collections = this.props.collections;
    for (var i = 0; i < collections.length; i++) {
      this.elements.push(new pyLeaflet.PathCollection(this, collections[i]));
    }
    var images = this.props.images;
    for (var i = 0; i < images.length; i++) {
      this.elements.push(new pyLeaflet.Image(this, images[i]));
    }
    this.elements.sort(function(a, b) {
      return a.props.zorder - b.props.zorder;
    });
  }
  pyLeaflet_Axes.prototype.draw = function() {
    for (var i = 0; i < this.props.sharex.length; i++) {
      this.sharex.push(pyLeaflet.get_element(this.props.sharex[i]));
    }
    for (var i = 0; i < this.props.sharey.length; i++) {
      this.sharey.push(pyLeaflet.get_element(this.props.sharey[i]));
    }
    ...
    // this.baseaxes = this.fig.canvas.append("g").attr("transform", "translate(" + pt0.x + "," + pt1.y + ")").attr("width", mwidth).attr("height", mheight).attr("class", "mpld3-baseaxes");
    this.baseaxes = this.fig.canvas.append("g").attr("transform", "translate(" + 0 + "," + 0 + ")").attr("width", mwidth).attr("height", mheight).attr("class", "mpld3-baseaxes");
    ...
    this.clip = this.baseaxes.append("svg:clipPath").attr("id", this.clipid).append("svg:rect").attr("x", 0).attr("y", 0).attr("width", mwidth).attr("height", mheight);
    this.axes = this.baseaxes.append("g").attr("class", "mpld3-axes").attr("clip-path", "url(#" + this.clipid + ")").attr("width", mwidth).attr("height", mheight);;
    ...
    this.axesbg = this.axes.append("svg:rect").attr("width", mwidth).attr("height", mheight).attr("class", "mpld3-axesbg").style("fill", "None").style("fill-opacity", this.props.axesbgalpha);
    for (var i = 0; i < this.elements.length; i++) {
      this.elements[i].draw();
    }
  };
  pyLeaflet_Axes.prototype.enable_zoom = function() {
  ...
  pyLeaflet_Axes.prototype.disable_zoom = function() {
    if (this.props.zoomable) {
  ...
  pyLeaflet_Axes.prototype.zoomed = function(propagate) {
  ...
  pyLeaflet_Axes.prototype.reset = function(duration, propagate) {
    this.set_axlim(this.props.xdomain, this.props.ydomain, duration, propagate);
  };
  pyLeaflet_Axes.prototype.set_axlim = function(xlim, ylim, duration, propagate) {
    ...
    var interpX = this.props.xscale === "date" ? pyLeaflet.interpolateDates(this.xdom.domain(), xlim) : d3.interpolate(this.xdom.domain(), xlim);
    var interpY = this.props.yscale === "date" ? pyLeaflet.interpolateDates(this.ydom.domain(), ylim) : d3.interpolate(this.ydom.domain(), ylim);
  ...
  pyLeaflet.Toolbar = pyLeaflet_Toolbar;
  pyLeaflet_Toolbar.prototype = Object.create(pyLeaflet_PlotElement.prototype);
  pyLeaflet_Toolbar.prototype.constructor = pyLeaflet_Toolbar;
  pyLeaflet_Toolbar.prototype.defaultProps = {
    buttons: [ "reset", "move" ]
  };
  function pyLeaflet_Toolbar(fig, props) {
    pyLeaflet_PlotElement.call(this, fig, props);
    this.buttons = [];
    this.props.buttons.forEach(this.addButton.bind(this));
  }
  pyLeaflet_Toolbar.prototype.addButton = function(button) {
    this.buttons.push(new button(this));
  };
  pyLeaflet_Toolbar.prototype.draw = function() {
    pyLeaflet.insert_css("div#" + this.fig.figid + " .mpld3-toolbar image", {
      cursor: "pointer",
      opacity: .2,
      display: "inline-block",
      margin: "0px"
    });
    pyLeaflet.insert_css("div#" + this.fig.figid + " .mpld3-toolbar image.active", {
      opacity: .4
    });
    pyLeaflet.insert_css("div#" + this.fig.figid + " .mpld3-toolbar image.pressed", {
      opacity: .6
    });
  ...
  pyLeaflet_Toolbar.prototype.deactivate_all = function() {
    this.buttons.forEach(function(b) {
      b.deactivate();
    });
  };
  pyLeaflet_Toolbar.prototype.deactivate_by_action = function(actions) {
    function filt(e) {
  ...
  pyLeaflet.Button = pyLeaflet_Button;
  pyLeaflet_Button.prototype = Object.create(pyLeaflet_PlotElement.prototype);
  pyLeaflet_Button.prototype.constructor = pyLeaflet_Button;
  function pyLeaflet_Button(toolbar, key) {
    pyLeaflet_PlotElement.call(this, toolbar);
    this.toolbar = toolbar;
    this.fig = this.toolbar.fig;
    this.cssclass = "mpld3-" + key + "button";
    this.active = false;
  }
  pyLeaflet_Button.prototype.setState = function(state) {
    state ? this.activate() : this.deactivate();
  };
  pyLeaflet_Button.prototype.click = function() {
    this.active ? this.deactivate() : this.activate();
  };
  pyLeaflet_Button.prototype.activate = function() {
  ...
  pyLeaflet_Button.prototype.deactivate = function() {
    this.onDeactivate();
    this.active = false;
    this.toolbar.toolbar.select("." + this.cssclass).classed({
      pressed: false
  ...
  pyLeaflet_Button.prototype.sticky = false;
  pyLeaflet_Button.prototype.actions = [];
  pyLeaflet_Button.prototype.icon = function() {
    return "";
  };
  pyLeaflet_Button.prototype.onActivate = function() {};
  pyLeaflet_Button.prototype.onDeactivate = function() {};
  pyLeaflet_Button.prototype.onDraw = function() {};
  pyLeaflet.ButtonFactory = function(members) {
    if (typeof members.buttonID !== "string") {
      throw "ButtonFactory: buttonID must be present and be a string";
    }
    function B(toolbar) {
      pyLeaflet_Button.call(this, toolbar, this.buttonID);
    }
    B.prototype = Object.create(pyLeaflet_Button.prototype);
  ...
  pyLeaflet.Plugin = pyLeaflet_Plugin;
  pyLeaflet_Plugin.prototype = Object.create(pyLeaflet_PlotElement.prototype);
  pyLeaflet_Plugin.prototype.constructor = pyLeaflet_Plugin;
  pyLeaflet_Plugin.prototype.requiredProps = [];
  pyLeaflet_Plugin.prototype.defaultProps = {};
  function pyLeaflet_Plugin(fig, props) {
    pyLeaflet_PlotElement.call(this, fig, props);
  }
  pyLeaflet_Plugin.prototype.draw = function() {};
  pyLeaflet.ResetPlugin = pyLeaflet_ResetPlugin;
  pyLeaflet.register_plugin("reset", pyLeaflet_ResetPlugin);
  pyLeaflet_ResetPlugin.prototype = Object.create(pyLeaflet_Plugin.prototype);
  pyLeaflet_ResetPlugin.prototype.constructor = pyLeaflet_ResetPlugin;
  pyLeaflet_ResetPlugin.prototype.requiredProps = [];
  pyLeaflet_ResetPlugin.prototype.defaultProps = {};
  function pyLeaflet_ResetPlugin(fig, props) {
    pyLeaflet_Plugin.call(this, fig, props);
    var ResetButton = pyLeaflet.ButtonFactory({
      buttonID: "reset",
      sticky: false,
      onActivate: function() {
      ...
      icon: function() {
        return pyLeaflet.icons["reset"];
      }
    });
    this.fig.buttons.push(ResetButton);
  }
  pyLeaflet.ZoomPlugin = pyLeaflet_ZoomPlugin;
  pyLeaflet.register_plugin("zoom", pyLeaflet_ZoomPlugin);
  pyLeaflet_ZoomPlugin.prototype = Object.create(pyLeaflet_Plugin.prototype);
  pyLeaflet_ZoomPlugin.prototype.constructor = pyLeaflet_ZoomPlugin;
  pyLeaflet_ZoomPlugin.prototype.requiredProps = [];
  pyLeaflet_ZoomPlugin.prototype.defaultProps = {
    button: true,
    enabled: null
  };
  function pyLeaflet_ZoomPlugin(fig, props) {
    pyLeaflet_Plugin.call(this, fig, props);
    ...
    if (this.props.button) {
      var ZoomButton = pyLeaflet.ButtonFactory({
        buttonID: "zoom",
        sticky: true,
        actions: [ "scroll", "drag" ],
        ...
        icon: function() {
          return pyLeaflet.icons["move"];
        }
      });
      this.fig.buttons.push(ZoomButton);
    }
  }
  pyLeaflet_ZoomPlugin.prototype.activate = function() {
    this.fig.enable_zoom();
  };
  pyLeaflet_ZoomPlugin.prototype.deactivate = function() {
    this.fig.disable_zoom();
  };
  pyLeaflet_ZoomPlugin.prototype.draw = function() {
    if (this.props.enabled) this.fig.enable_zoom(); else this.fig.disable_zoom();
  };
  pyLeaflet.BoxZoomPlugin = pyLeaflet_BoxZoomPlugin;
  pyLeaflet.register_plugin("boxzoom", pyLeaflet_BoxZoomPlugin);
  pyLeaflet_BoxZoomPlugin.prototype = Object.create(pyLeaflet_Plugin.prototype);
  pyLeaflet_BoxZoomPlugin.prototype.constructor = pyLeaflet_BoxZoomPlugin;
  pyLeaflet_BoxZoomPlugin.prototype.requiredProps = [];
  pyLeaflet_BoxZoomPlugin.prototype.defaultProps = {
    button: true,
    enabled: null
  };
  function pyLeaflet_BoxZoomPlugin(fig, props) {
    pyLeaflet_Plugin.call(this, fig, props);
    if (this.props.enabled === null) {
      this.props.enabled = !this.props.button;
    }
    var enabled = this.props.enabled;
    if (this.props.button) {
      var BoxZoomButton = pyLeaflet.ButtonFactory({
        buttonID: "boxzoom",
        sticky: true,
        actions: [ "drag" ],
        onActivate: this.activate.bind(this),
  ...
  pyLeaflet_BoxZoomPlugin.prototype.activate = function() {
    if (this.enable) this.enable();
  };
  pyLeaflet_BoxZoomPlugin.prototype.deactivate = function() {
    if (this.disable) this.disable();
  };
  pyLeaflet_BoxZoomPlugin.prototype.draw = function() {
    pyLeaflet.insert_css("#" + this.fig.figid + " rect.extent." + this.extentClass, {
      fill: "#fff",
      "fill-opacity": 0,
      stroke: "#999"
    });
  ...
  pyLeaflet.TooltipPlugin = pyLeaflet_TooltipPlugin;
  pyLeaflet.register_plugin("tooltip", pyLeaflet_TooltipPlugin);
  pyLeaflet_TooltipPlugin.prototype = Object.create(pyLeaflet_Plugin.prototype);
  pyLeaflet_TooltipPlugin.prototype.constructor = pyLeaflet_TooltipPlugin;
  pyLeaflet_TooltipPlugin.prototype.requiredProps = [ "id" ];
  pyLeaflet_TooltipPlugin.prototype.defaultProps = {
    labels: null,
    hoffset: 0,
    voffset: 10,
    location: "mouse"
  };
  function pyLeaflet_TooltipPlugin(fig, props) {
    pyLeaflet_Plugin.call(this, fig, props);
  }
  pyLeaflet_TooltipPlugin.prototype.draw = function() {
    var obj = pyLeaflet.get_element(this.props.id, this.fig);
  ...
  pyLeaflet.LinkedBrushPlugin = pyLeaflet_LinkedBrushPlugin;
  pyLeaflet.register_plugin("linkedbrush", pyLeaflet_LinkedBrushPlugin);
  pyLeaflet_LinkedBrushPlugin.prototype = Object.create(pyLeaflet.Plugin.prototype);
  pyLeaflet_LinkedBrushPlugin.prototype.constructor = pyLeaflet_LinkedBrushPlugin;
  pyLeaflet_LinkedBrushPlugin.prototype.requiredProps = [ "id" ];
  pyLeaflet_LinkedBrushPlugin.prototype.defaultProps = {
    button: true,
    enabled: null
  };
  function pyLeaflet_LinkedBrushPlugin(fig, props) {
    pyLeaflet.Plugin.call(this, fig, props);
    if (this.props.enabled === null) {
      this.props.enabled = !this.props.button;
    }
    var enabled = this.props.enabled;
    if (this.props.button) {
      var BrushButton = pyLeaflet.ButtonFactory({
  ...
  pyLeaflet_LinkedBrushPlugin.prototype.activate = function() {
    if (this.enable) this.enable();
  };
  pyLeaflet_LinkedBrushPlugin.prototype.deactivate = function() {
    if (this.disable) this.disable();
  };
  pyLeaflet_LinkedBrushPlugin.prototype.draw = function() {
    var obj = pyLeaflet.get_element(this.props.id);
    if (obj === null) {
    ...
    pyLeaflet.insert_css("#" + fig.figid + " rect.extent." + this.extentClass, {
      fill: "#000",
      "fill-opacity": .125,
      stroke: "#fff"
    });
    pyLeaflet.insert_css("#" + fig.figid + " path.mpld3-hidden", {
      stroke: "#ccc !important",
      fill: "#ccc !important"
    });
    var dataClass = "pyLeafletdata-" + obj.props[dataKey];
  ...
  pyLeaflet.register_plugin("mouseposition", MousePositionPlugin);
  MousePositionPlugin.prototype = Object.create(pyLeaflet.Plugin.prototype);
  ...
  pyLeaflet.Figure = pyLeaflet_Figure;
  pyLeaflet_Figure.prototype = Object.create(pyLeaflet_PlotElement.prototype);
  pyLeaflet_Figure.prototype.constructor = pyLeaflet_Figure;
  pyLeaflet_Figure.prototype.requiredProps = [ "width", "height" ];
  pyLeaflet_Figure.prototype.defaultProps = {
    data: {},
    axes: [],
    plugins: [ {
      type: "reset"
  ...
  function pyLeaflet_Figure(figid, props) {
    pyLeaflet_PlotElement.call(this, null, props);
    this.figid = figid;
    ...
    this.buttons = [];
    this.root = svg//d3.select("#" + figid).append("div").style("position", "relative");
    this.axes = [];
    for (var i = 0; i < this.props.axes.length; i++) this.axes.push(new pyLeaflet_Axes(this, this.props.axes[i]));
    this.plugins = [];
    for (var i = 0; i < this.props.plugins.length; i++) this.add_plugin(this.props.plugins[i]);
    this.toolbar = new pyLeaflet.Toolbar(this, {
      buttons: this.buttons
    });
  }
  pyLeaflet_Figure.prototype.getBrush = function() {
  ...
  pyLeaflet_Figure.prototype.showBrush = function(extentClass) {
  ...
  pyLeaflet_Figure.prototype.hideBrush = function(extentClass) {
    extentClass = typeof extentClass === "undefined" ? "" : extentClass;
    var brush = this.getBrush();
  ...
  pyLeaflet_Figure.prototype.add_plugin = function(props) {
    var plug = props.type;
    if (typeof plug === "undefined") {
      console.warn("unspecified plugin type. Skipping this");
      return;
    }
    props = pyLeaflet_cloneObj(props);
    delete props.type;
    if (plug in pyLeaflet.plugin_map) plug = pyLeaflet.plugin_map[plug];
  ...
  pyLeaflet_Figure.prototype.draw = function() {
    this.canvas = g;//this.root.append("svg:svg").attr("class", "mpld3-figure").attr("width", this.width).attr("height", this.height);
  ...
  pyLeaflet_Figure.prototype.reset = function(duration) {
    this.axes.forEach(function(ax) {
      ax.reset(duration, false);
    });
  };
  pyLeaflet_Figure.prototype.enable_zoom = function() {
    for (var i = 0; i < this.axes.length; i++) {
      this.axes[i].enable_zoom();
    }
    this.zoom_on = true;
  };
  pyLeaflet_Figure.prototype.disable_zoom = function() {
    for (var i = 0; i < this.axes.length; i++) {
      this.axes[i].disable_zoom();
    }
    this.zoom_on = false;
  };
  pyLeaflet_Figure.prototype.toggle_zoom = function() {
    if (this.zoom_on) {
      this.disable_zoom();
    } else {
      this.enable_zoom();
  ...
  pyLeaflet_Figure.prototype.get_data = function(data) {
  ...
  pyLeaflet.PlotElement = pyLeaflet_PlotElement;
  function pyLeaflet_PlotElement(parent, props) {
    this.parent = isUndefinedOrNull(parent) ? null : parent;
    this.props = isUndefinedOrNull(props) ? {} : this.processProps(props);
    this.fig = parent instanceof pyLeaflet_Figure ? parent : parent && "fig" in parent ? parent.fig : null;
    this.ax = parent instanceof pyLeaflet_Axes ? parent : parent && "ax" in parent ? parent.ax : null;
  }
  pyLeaflet_PlotElement.prototype.requiredProps = [];
  pyLeaflet_PlotElement.prototype.defaultProps = {};
  pyLeaflet_PlotElement.prototype.processProps = function(props) {
    props = pyLeaflet_cloneObj(props);
    var finalProps = {};
    ...
    if ("id" in props) {
      ...
      finalProps.id = pyLeaflet.generateId();
    }
    for (var p in props) {
  ...
  pyLeaflet_PlotElement.prototype.name = function() {
    var funcNameRegex = /function (.{1,})\(/;
    var results = funcNameRegex.exec(this.constructor.toString());
    return results && results.length > 1 ? results[1] : "";
  };
  if (typeof module === "object" && module.exports) {
    module.exports = pyLeaflet;
  } else {
    this.pyLeaflet = pyLeaflet;
  }
  console.log("Loaded pyLeaflet version " + pyLeaflet.version);
}(d3);